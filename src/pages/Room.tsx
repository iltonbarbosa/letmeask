...
export function Room() {
	...
	async function handleSendQuestion(event: FormEvent){
		...
		if(!user){//Aqui pode-se implementar a biblioteca React Hot Toast
	...
	async function handleLikeQuestion(questionId: string, likeId: string | undefined){
		if(likeId){
			await database.ref(`rooms/${room.id}/questions/${questionId}/likes/${likeId}`).remove()
		}else {
			await database.ref(`rooms/${room.id}/questions/${questionId}/likes`).push({
				authorId: user?.id
			})
		}
	}
